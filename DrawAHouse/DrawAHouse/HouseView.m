...
//  DrawAHouse
//
//  Created by Charles McQuilkin on 10/29/14.
...
- (void)drawRect:(CGRect)rect {
    ...
    [bezierPath addLineToPoint:CGPointMake(2/3.0 * self.bounds.size.width, 1/3.0 * self.bounds.size.height)];
    [bezierPath addLineToPoint:CGPointMake(1/2.5 * self.bounds.size.width, 1/4.0 * self.bounds.size.height)];
